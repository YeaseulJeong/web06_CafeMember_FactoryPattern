...
<body>
<h1>MemberCafe FrontController 회원관리 </h1><p>
<%--
 ...
 <c:choose>
 	<c:when test="${!empty vo}">
 		<a href="front.do?command=logout" >로그 아웃</a><br>    <!--  hidden tag 는 form 안에서만 쓰이니까 이런식으로 안보이게 넘긴다  -->
 		<a href="front.do?command=allmember">전체 회원 보기</a><br>
